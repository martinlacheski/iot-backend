const DataCarbonMonoxide = require("../../models/data/DataCarbonMonoxide");

async function getMinMaxBetweenDatesMQ7(fromDate, toDate, minutes) {
  try {
    // LISTADO DE REGISTROS
    const records = await DataCarbonMonoxide.find({
      timestamp: {
        $gte: fromDate,
        $lte: toDate,
      },
