...
const { getTypesOfEnvironments, createTypeOfEnvironment, updateTypeOfEnvironment, deleteTypeOfEnvironment } = require('../../controllers/admin/typeOfEnvironmentController');
